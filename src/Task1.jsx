...
function Task1() {
    return(
        <>
        <div className="border border-black   m-20 rounded-4xl bg-gray-300" >
            <div className="md:text-4xl sm:text-2xl text-blue-950 font-serif text-center m-10 font-bold">
                Departments
            </div >
            <div className=" grid grid-cols-1 md:grid-cols-3 gap-6 m-3 rounded-4xl">
